...
> **Status**: SciStudio is in **pre-alpha** (v0.2.1a0). The core runtime, block system, execution engine, API layer, and frontend workflow editor are implemented and under active development. See [Current Status](#current-status) for details.
...
SciStudio is in **pre-alpha** (v0.2.1a0). The following is implemented and under active development:
