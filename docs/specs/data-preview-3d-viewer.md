...
The right-column **Data Preview** panel in SciStudio renders block outputs as type-specific previews. Two long-standing UX gaps surfaced live in the microplastic-calibration project (2026-05-15):
