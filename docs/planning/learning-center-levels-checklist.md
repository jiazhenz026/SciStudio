...
| `P3` | `test_engineer` | `N/A` | prompts file §P3 | Windows-failing LC tests (#2075) | `fix/2075-lc-windows-tests` | `C:/Users/jiazh/workspace/SciStudio-wt-lcP3` | the 8 named test files/fixtures only | production code | #2075 / PR #2098 | `[x]` PR open |
