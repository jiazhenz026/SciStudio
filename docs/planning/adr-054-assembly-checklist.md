...
| `S4-D1` | `test_engineer` | `N/A` | `docs/planning/adr-054-assembly-dispatch-prompts/s4-d1-adversarial.md` | Adversarial tests against the assembled spec 4 frontend | `test/2253-adversarial` | `.worktrees/s4-d1` | `frontend/**/*.test.tsx`, `frontend/e2e/**`, fixtures | production frontend code | `#2253` | `[x]` |
| `S5-D1` | `test_engineer` | `N/A` | `docs/planning/adr-054-assembly-dispatch-prompts/s5-d1-adversarial.md` | Adversarial tests against the assembled spec 5 agent surface | `test/2254-adversarial` | `.worktrees/s5-d1` | `tests/ai/**`, `tests/agent_provisioning/**`, fixtures | production code | `#2254` | `[ `[x]` |
...
- [x] `S4-D1` adversarial test suite -> `frontend/src/store/__tests__/exploreSlice.adversarial.test.ts`, `frontend/src/explore/PauseTab.adversarial.test.tsx`, `frontend/src/explore/NotebookShell.adversarial.test.tsx`; 17 confirmed defects (marked `it.fails`, each a live assertion that goes red when fixed) and 8 negative results, written up as `F-D1-001` .. `F-D1-017` in `docs/planning/adr-054-assembly-followups.md`
...
- [x] `S5-D1` adversarial test suite -> `tests/ai/test_workspace_focus_adversarial.py`, `tests/ai/test_mcp_tools_explore_adversarial.py`, `tests/ai/test_tool_catalog_counts_adversarial.py` (42 tests: 37 green, 5 `xfail(strict=True)` defect markers); findings S5-D1-001..008 in `docs/planning/adr-054-assembly-followups.md`
