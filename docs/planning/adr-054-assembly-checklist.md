...
| `S5-B4` | `implementer` | `N/A` | `docs/planning/adr-054-assembly-dispatch-prompts/s5-b4-skills-and-counts.md` | Panel skill, block skill, base skill, provisioning counts, examples, catalogs (T-005, T-007, T-008, T-009) | `feat/2254-skills-and-counts` | `.worktrees/s5-b4` | `_skills/**`, `agent_provisioning/**`, `tools_authoring.py`, count assertions | tools_panels, tools_explore implementation | `#2254` | `[x]` T-005/T-007/T-008 done; T-009 done for the 40 tools registered today (S5-B2's panel group included, five count sites consolidated into `tests/mcp_tool_expectations.py`); S5-B3's seven session tools land the last move to 47 (see `adr-054-assembly-followups.md` F-B4-2) |
