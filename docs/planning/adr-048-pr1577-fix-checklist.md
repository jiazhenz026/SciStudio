...
| Pre-PR reconcile | `python -m scistudio.qa.governance.gate_record check --mode pre-pr --pr-body-file .workflow/local/pr-body-1644.md` | N/A | `[ ]` | pending |
...
| Gate ledger check (pre-PR) | `python -m scistudio.qa.governance.gate_record check --mode pre-pr --base origin/track/adr-048-spec1-preview-system --head HEAD --pr-body-file .workflow/local/pr-body-1644.md` | `[x]` | passed; mode=pre-pr tier=2 checks=`format_check`, `full_audit`, `lint_format`; reconciliation passed |
| Gate finalize (pre-PR) | `python -m scistudio.qa.governance.gate_record finalize --base origin/track/adr-048-spec1-preview-system --head HEAD --commit <sha> --pr-body-file .workflow/local/pr-body-1644.md --closes "#1644"` | `[ ]` | pending |
