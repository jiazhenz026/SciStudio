...
|---|---|---|---|---|---|---|---|---|---|---|
| `AUD-1 drift` | `audit_reviewer` | `no-context` | audit-no-context template (composed verbatim, §7.1) | ADR/spec ⇄ code contract drift across whole repo | n/a (read-only) | n/a (read-only) | report returned to manager | edit any file; read issues/records/PRs | `#1589` | `[ ]` |
| `AUD-2 routing` | `audit_reviewer` | `no-context` | audit-no-context template (composed verbatim, §7.2) | layer & module routing / boundary integrity across src+packages+frontend | n/a (read-only) | n/a (read-only) | report returned to manager | edit any file; read issues/records/PRs | `#1589` | `[ ]` |
| `AUD-3 bugs` | `audit_reviewer` | `no-context` | audit-no-context template (composed verbatim, §7.3) | serious code bugs / correctness defects in runtime path | n/a (read-only) | n/a (read-only) | report returned to manager | edit any file; read issues/records/PRs | `#1589` | `[ ]` |
...
- [ ] Dispatched. [ ] Findings returned. [ ] Report persisted. [ ] P1 verified by manager.
...
- [ ] All 3 audit agents returned findings.
- [ ] Each per-lens audit report file persisted under `docs/audit/`.
- [ ] Consolidated index report persisted.
- [ ] Manager spot-verified every P1/blocking finding against cited code.
- [ ] Findings recorded with severity ordering.
- [ ] Follow-up issues opened for actionable findings (or rationale recorded).
...
|---|---|---|---|---|
| `2026-06-11` | `manager` | `none yet` | `n/a` | `n/a` |
