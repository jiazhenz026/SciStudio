...
- [x] `S3-A2` kernel handle -> `src/scistudio/explore/kernel.py`, `tests/explore/test_kernel_session.py`; `PYTHONPATH=./src python -m pytest tests/explore/test_kernel_session.py -q` -> 47 passed, 1 skipped (real ipykernel); gate record `.workflow/records/2240-feat-2240-kernel-handle.json`
