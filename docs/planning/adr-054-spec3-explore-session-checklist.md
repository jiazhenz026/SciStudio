...
- [x] `S3-A3` plumbing commits to a ref -> branch `feat/2240-explore-commits`; `src/scistudio/core/versioning/_commit_ops.py` + `tests/core/versioning/test_explore_ref_commits.py`; `PYTHONPATH=./src python -m pytest tests/core/versioning/ tests/core/test_git_engine.py --no-cov` -> 144 passed; gate ledger `.workflow/records/2240-feat-2240-explore-commits.json`
