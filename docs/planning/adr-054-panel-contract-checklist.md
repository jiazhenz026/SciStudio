...
| `W4-builtin` | `implementer` | `N/A` | `adr-054-panel-contract-prompts.md#w4-builtin` | T-009 | `feat/2229-builtin-panels` | `.worktrees/w4-builtin-panels` | the built-in panel directories and their tests | the Python providers, the host | `#2229` | `[~]` dispatched |
