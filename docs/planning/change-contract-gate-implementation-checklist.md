...
- [ ] Schema models implemented -> pending.
- [ ] Tests added -> pending.
- [ ] Docs or N/A recorded -> pending.
...
- [ ] Python import roots implemented -> pending.
- [ ] TypeScript import roots implemented -> pending.
- [ ] Entrypoint/canary path implemented -> pending.
