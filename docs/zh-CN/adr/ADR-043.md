...
1. **Trailer**: `Loosening-Approved: @<x id="31" data-kind="html-tag"/>` plus
   `Loosening-Reason: <x id="32" data-kind="html-tag"/>` on the commit.
...
3. **Errata-only patches** (typo, broken link, factual correction with no
   semantic change): allowed with `Errata-Only: <x id="33" data-kind="html-tag"/>` trailer plus
...
| **Skill** (`.claude/skills/<x id="34" data-kind="html-tag"/>/SKILL.md`) | Description-matched (medium reliability) OR manual `/<x id="35" data-kind="html-tag"/>` (perfect) | Loaded on auto-trigger or invocation | Multi-step procedures (e.g., workflow gate, hotfix mode, agent-manager dispatch) |
...
logs to `docs/audit/instructions-loaded-trace/<x id="36" data-kind="html-tag"/>.jsonl` every rule
...
1. The PR carries `Loosening-Approved: @<x id="37" data-kind="html-tag"/>` trailer (per
   §3.4.2).
