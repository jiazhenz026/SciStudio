...
carry `length_exception_reason: "<x id="21" data-kind="html-tag"/>"` AND link to an open issue
...
A single user-doc page that explains what `<x id="22" data-kind="html-tag"/>/CLAUDE.md`,
`<x id="23" data-kind="html-tag"/>/AGENTS.md`, `<x id="24" data-kind="html-tag"/>/.claude/`, `<x id="25" data-kind="html-tag"/>/.codex/` are when
...
|---|---|---|
| **Procedural** | `docs/contributing/workflows/<x id="26" data-kind="html-tag"/>.md` | new-feature, bug-fix, hotfix, agent-dispatch, testing |
| **Tool-wrapping** | `docs/contributing/reference/<x id="27" data-kind="html-tag"/>.md` OR the audit tool's module docstring | doc-drift-guard, provenance-tagger, adr-router, mantis-proof, session-logs |
...
4. `<x id="28" data-kind="html-tag"/>/CLAUDE.md` + `<x id="29" data-kind="html-tag"/>/AGENTS.md` auto-provisioning
...
- `<x id="30" data-kind="html-tag"/>/CLAUDE.md`, `<x id="31" data-kind="html-tag"/>/AGENTS.md`
- `<x id="32" data-kind="html-tag"/>/.claude/settings.json`, `<x id="33" data-kind="html-tag"/>/.claude/hooks/*.py` (6 scripts)
- `<x id="34" data-kind="html-tag"/>/.claude/skills/<x id="35" data-kind="html-tag"/>/SKILL.md` (flat per Addendum 1)
- `<x id="36" data-kind="html-tag"/>/.agents/skills/<x id="37" data-kind="html-tag"/>/SKILL.md` (flat)
- `<x id="38" data-kind="html-tag"/>/.codex/config.toml`
