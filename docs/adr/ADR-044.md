...
## 14. Implementation Plan Adjustments (owner rewrite pending)

The ADR-044 documentation-stack implementation plan was intentionally cleared
on 2026-05-18 together with ADR-042 section 26.

This addendum still defines the documentation architecture, schemas,
Sphinx/generator expectations, and anti-drift rules. It no longer assigns
those requirements to phase numbers or delivery steps until the owner lands a
replacement plan.
