...
governs:
  modules:
    - scieasy.core.metadata_store
    - scieasy.core.lineage.store
  contracts:
    - scieasy.core.metadata_store.MetadataStore
    - scieasy.core.metadata_store.get_metadata_store
    - scieasy.core.metadata_store.set_metadata_store
    - scieasy.core.lineage.store.LineageStore
  entry_points: []
  files:
    - docs/adr/ADR-032.md
    - src/scieasy/core/metadata_store.py
...
into the unified `.scieasy/lineage.db` model.
...
> below has been collapsed into a single `<project>/.scieasy/lineage.db` with four
...
> consult ADR-038 instead. The `src/scieasy/core/metadata_store.py` module is
