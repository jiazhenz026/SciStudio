...
automatic installation of host-native hooks, adoption of hackathon UX,
multi-user login in the open-source edition, and automatic loading of identity
backends from entry points.
