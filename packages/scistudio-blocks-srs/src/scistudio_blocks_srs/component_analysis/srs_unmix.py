...
from scistudio_blocks_imaging.types import Image  # type: ignore[import-not-found]
...
from scistudio_blocks_srs.component_analysis.srs_vca import _extract_endmembers
