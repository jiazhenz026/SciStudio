...
# The SRS test environment in CI installs ``scieasy-blocks-imaging`` as a dep
# (declared in ``packages/scieasy-blocks-srs/pyproject.toml``); local
...
from scieasy_blocks_imaging.types import Image as ImagingImage
from scieasy_blocks_imaging.types import Label
from scieasy_blocks_srs import (
    SRSPCA,
    SRSBaseline,
    SRSCalibrate,
    SRSImage,
