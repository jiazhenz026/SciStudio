...
// ---------------------------------------------------------------------------
// #1420 regression: InlineTextInputField hook order
//
// The default text-input branch of InlineConfigField was extracted into its
// own InlineTextInputField sub-component so that useState / useRef /
// useLayoutEffect now sit at the top level of every component in this file
// (rules-of-hooks). The behavior must stay identical:
...
// throwing the React "Hooks called conditionally" error.
// ---------------------------------------------------------------------------
