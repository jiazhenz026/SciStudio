...
class Image(Array):
    ...
    # Your type, your colour. Uncomment the two lines below and pick any CSS
    # hex values — they colour this type's tile in the Data types tab and every
    # canvas port that carries an Image. A value that is not a CSS hex colour
    # is ignored with a warning, so a typo costs you the colour and nothing
    # else. Leave them commented and SciStudio picks a stable colour for you.
    #
    #   ui_color: ClassVar[str | None] = "#4f8ef7"       # the fill
    #   ui_ring_color: ClassVar[str | None] = "#1b4f9c"  # the outline
