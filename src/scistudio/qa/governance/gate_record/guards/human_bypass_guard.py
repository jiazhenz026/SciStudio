...
Produces: human-authored/admin-approved:bypass claimed without verified maintainer/admin provenance.
...
def check(inputs: GuardInputs) -> AuditReport:
    """Evaluate the human_bypass_guard obligation.
    ...
    return empty_report("human_bypass_guard", inputs.repo_root)
