...
Produces: Removal of required check tokens or addition of CI-weakening constructs.
...
def check(inputs: GuardInputs) -> AuditReport:
    """Evaluate the weakened_ci_check obligation.
    ...
    return empty_report("weakened_ci_check", inputs.repo_root)
