...
Produces: No linked issue; structurally invalid issue; PR body missing closing keyword per issue.
...
def check(inputs: GuardInputs) -> AuditReport:
    """Evaluate the issue_link obligation.
    ...
    return empty_report("issue_link", inputs.repo_root)
