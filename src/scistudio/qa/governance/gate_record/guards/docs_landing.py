...
Produces: Governed change without docs/changelog/checklist landing or explicit N/A.
...
def check(inputs: GuardInputs) -> AuditReport:
    """Evaluate the docs_landing obligation.
    ...
    return empty_report("docs_landing", inputs.repo_root)
