...
_TIER_NOTE: dict[int, str] = {
    1: (
        ...
        "--force-checks to run the repository-wide mirror locally (python_tests excepted: the full "
        "Python suite never runs locally; unmapped tests are deferred to CI)."
    ),
