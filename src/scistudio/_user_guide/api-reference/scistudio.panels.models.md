...
Canonical import root: `from scistudio.panels.models import ...`
...
## `PanelEntryPoint` — _protocol_

**Stability:** `provisional` · Since `0.3.1`

```python
class PanelEntryPoint(Protocol)
PanelEntryPoint(*args, **kwargs)
```
...
`PanelSpec`. Each returned spec declares
...
```python
class PanelSpec
PanelSpec(previewer_id: 'str', owner_kind: 'OwnerKind', owner_name: 'str', target_type: 'str', supports_collection: 'bool' = False, priority: 'int' = 0, features: 'tuple[str, ...]' = (), backend_provider: 'PreviewProvider | str | None' = None, resource_provider: 'PreviewResourceProvider | str | None' = None, frontend_manifest: 'FrontendManifest | None' = None, api_version: 'str' = '1') -> None
```
...
PreviewRequest(target: 'PreviewTarget', spec: 'PanelSpec', query: 'dict[str, Any]', data_access: 'PreviewDataAccess', limits: 'PreviewLimits', session_id: 'str | None' = None, storage: 'StorageReference | None' = None, record_metadata: 'dict[str, Any]' = <factory>) -> None
```
