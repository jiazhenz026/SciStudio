...
Self-contained public-API reference — 60 symbols from this module's `__all__`, with signatures and docstrings inlined. Generated; do not hand-edit.
...
- `supports(self, script_path: 'Path', config: 'CodeBlockConfig') -> 'bool'` — _unmarked — no runtime stability marker_ — Return whether this backend can run the script at *script_path*.
- `resolve(self, context: 'CodeBlockRuntimeContext') -> 'ResolvedInterpreter'` — _unmarked — no runtime stability marker_ — Resolve the interpreter command and environment for a run.
- `run(self, context: 'CodeBlockRuntimeContext', interpreter: 'ResolvedInterpreter') -> 'subprocess.CompletedProcess[str]'` — _unmarked — no runtime stability marker_ — Launch the resolved interpreter and return the finished process.
...
- `resolve_script_path(self, project_dir: 'Path') -> 'Path'` — _unmarked — no runtime stability marker_ — Resolve ``script_path`` to an absolute path inside the project.
- `resolve_working_directory(self, project_dir: 'Path') -> 'Path'` — _unmarked — no runtime stability marker_ — Resolve ``working_directory`` to an absolute path inside the project.
- `resolve_exchange_root(self, project_dir: 'Path') -> 'Path'` — _unmarked — no runtime stability marker_ — Resolve ``exchange_root`` to an absolute path inside the project.
...
- `input_folders(self) -> 'dict[str, Path]'` — _unmarked — no runtime stability marker_ — Map each input port name to its on-disk folder.
- `output_folders(self) -> 'dict[str, Path]'` — _unmarked — no runtime stability marker_ — Map each output port name to its on-disk folder.
- `to_dict(self) -> 'dict[str, object]'` — _unmarked — no runtime stability marker_ — Return the whole manifest as a JSON-serialisable dictionary.
...
- `render(self, *, node_id: 'str | None' = None) -> 'str'` — _unmarked — no runtime stability marker_ — Format this diagnostic as a one-line message for the workflow editor.
...
- `to_dict(self) -> 'dict[str, str | None]'` — _unmarked — no runtime stability marker_ — Return this diagnostic as a JSON-serialisable dictionary.
...
- `to_dict(self) -> 'dict[str, str | None]'` — _unmarked — no runtime stability marker_ — Return this record as a JSON-serialisable dictionary.
...
- `to_list(self) -> 'list[Any]'` — _unmarked — no runtime stability marker_ — Load all items into memory and return as a plain list.
...
- `supports(self, script_path: 'Path', config: 'CodeBlockConfig') -> 'bool'` — _unmarked — no runtime stability marker_ — Return whether *script_path* is a MATLAB-family script this backend runs.
- `resolve(self, context: 'CodeBlockRuntimeContext') -> 'ResolvedInterpreter'` — _unmarked — no runtime stability marker_ — Resolve a MATLAB or Octave interpreter and build its launch command.
- `run(self, context: 'CodeBlockRuntimeContext', interpreter: 'ResolvedInterpreter') -> 'subprocess.CompletedProcess[str]'` — _unmarked — no runtime stability marker_ — Launch MATLAB or Octave on the script and return the finished process.
...
- `supports(self, script_path: 'Path', config: 'CodeBlockConfig') -> 'bool'` — _unmarked — no runtime stability marker_ — Return whether *script_path* is a notebook this backend runs.
- `resolve(self, context: 'CodeBlockRuntimeContext') -> 'ResolvedInterpreter'` — _unmarked — no runtime stability marker_ — Resolve ``nbconvert`` and build the command that executes the notebook.
- `run(self, context: 'CodeBlockRuntimeContext', interpreter: 'ResolvedInterpreter') -> 'subprocess.CompletedProcess[str]'` — _unmarked — no runtime stability marker_ — Execute the notebook in place and return the finished process.
...
- `has_errors(self) -> 'bool'` — _unmarked — no runtime stability marker_ — Whether any diagnostic is an error.
...
- `to_dict(self) -> 'dict[str, object]'` — _unmarked — no runtime stability marker_ — Return this port record as a JSON-serialisable dictionary.
...
- `supports(self, script_path: 'Path', config: 'CodeBlockConfig') -> 'bool'` — _unmarked — no runtime stability marker_ — Return whether *script_path* is a Python script this backend runs.
- `resolve(self, context: 'CodeBlockRuntimeContext') -> 'ResolvedInterpreter'` — _unmarked — no runtime stability marker_ — Resolve the Python interpreter and exchange environment for a run.
- `run(self, context: 'CodeBlockRuntimeContext', interpreter: 'ResolvedInterpreter') -> 'subprocess.CompletedProcess[str]'` — _unmarked — no runtime stability marker_ — Launch the Python interpreter on the script and return the process.
...
- `supports(self, script_path: 'Path', config: 'CodeBlockConfig') -> 'bool'` — _unmarked — no runtime stability marker_ — Return whether *script_path* is an R or Quarto script this backend runs.
- `resolve(self, context: 'CodeBlockRuntimeContext') -> 'ResolvedInterpreter'` — _unmarked — no runtime stability marker_ — Resolve ``Rscript`` or ``quarto`` and build the launch command.
- `run(self, context: 'CodeBlockRuntimeContext', interpreter: 'ResolvedInterpreter') -> 'subprocess.CompletedProcess[str]'` — _unmarked — no runtime stability marker_ — Launch the R or Quarto command and return the finished process.
...
- `supports(self, script_path: 'Path', config: 'CodeBlockConfig') -> 'bool'` — _unmarked — no runtime stability marker_ — Return whether *script_path* is a shell script this backend runs.
- `resolve(self, context: 'CodeBlockRuntimeContext') -> 'ResolvedInterpreter'` — _unmarked — no runtime stability marker_ — Resolve a POSIX shell and build the launch command and environment.
- `run(self, context: 'CodeBlockRuntimeContext', interpreter: 'ResolvedInterpreter') -> 'subprocess.CompletedProcess[str]'` — _unmarked — no runtime stability marker_ — Launch the shell on the script and return the finished process.
