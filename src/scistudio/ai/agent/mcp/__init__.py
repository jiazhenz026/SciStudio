"""SciStudio MCP server (FastMCP migration)."""
...
# * :mod:`scistudio.ai.agent.mcp.tools_panels` — category (g): panel listing
#   (every kind), panel checking, and MiniApp opening (3 tools, ADR-054 MiniApp
#   FR-029/FR-030, #2441, and #2445).
#
