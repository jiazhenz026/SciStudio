...
class TestImportEngineModules:
    ...
    def test_import_dag(self) -> None:
        from scistudio.engine import dag  # noqa: F401

    def test_import_scheduler(self) -> None:
        from scistudio.engine import scheduler  # noqa: F401

    # ADR-020: batch module deleted — test removed.
    # def test_import_batch(self) -> None:
    #     from scistudio.engine import batch

    def test_import_checkpoint(self) -> None:
        from scistudio.engine import checkpoint  # noqa: F401

    def test_import_events(self) -> None:
        from scistudio.engine import events  # noqa: F401

    def test_import_resources(self) -> None:
        from scistudio.engine import resources  # noqa: F401

    def test_import_engine_runners(self) -> None:
        from scistudio.engine.runners import (
            base,  # noqa: F401
            local,  # noqa: F401
        )
...
class TestImportAPIModules:
    ...
    def test_import_app(self) -> None:
        from scistudio.api import app  # noqa: F401

    def test_import_schemas(self) -> None:
        from scistudio.api import schemas  # noqa: F401

    def test_import_deps(self) -> None:
        from scistudio.api import deps  # noqa: F401

    def test_import_sse(self) -> None:
        from scistudio.api import sse  # noqa: F401

    def test_import_ws(self) -> None:
        from scistudio.api import ws  # noqa: F401
    ...
    def test_instantiate_workflow_create(self) -> None:
        from scistudio.api.schemas import WorkflowCreate
    ...
    def test_instantiate_workflow_response(self) -> None:
        from scistudio.api.schemas import WorkflowResponse
    ...
    def test_instantiate_block_list_response(self) -> None:
        from scistudio.api.schemas import BlockListResponse

        blr = BlockListResponse(blocks=[])
        assert blr.blocks == []

    def test_instantiate_data_upload_response(self) -> None:
        from scistudio.api.schemas import DataUploadResponse
...
class TestImportWorkflowModules:
    ...
    def test_import_definition(self) -> None:
        from scistudio.workflow import definition  # noqa: F401

    def test_import_layout(self) -> None:
        from scistudio.workflow import layout  # noqa: F401

    def test_import_serializer(self) -> None:
        from scistudio.workflow import serializer  # noqa: F401

    def test_import_validator(self) -> None:
        from scistudio.workflow import validator  # noqa: F401
    ...
    def test_instantiate_edge_def(self) -> None:
        from scistudio.workflow.definition import EdgeDef
    ...
    def test_instantiate_layout_info(self) -> None:
        from scistudio.workflow.layout import LayoutInfo
...
class TestImportCLI:
    ...
    def test_import_cli_main(self) -> None:
        from scistudio.cli import main  # noqa: F401
