...
The #1063 port-shape regression lives in ``test_scaffold_template_regression.py``;
#2384 per-category scaffolding and the #2037 name validation are covered in
``test_scaffold_block_categories.py``.
"""
