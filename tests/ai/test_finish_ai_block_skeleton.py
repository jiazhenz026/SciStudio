...
def test_registry_now_has_53_tools() -> None:
    """ADR-035 §3.5 + ADR-040 §3.1 + Addendum 5 + ADR-048 SPEC 2 + #1912 + #1947 + ADR-053 FR-011 + ADR-054 + ADR-055 Spec 2: FastMCP exposes 53 tools."""
    from scistudio.ai.agent.mcp.server import mcp
