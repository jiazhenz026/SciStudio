"""Package previewers render with the plugin import roots active (#2112, FR-044).

A package previewer module is importable at render time only because discovery
...
def _spec(owner_kind: OwnerKind, provider) -> PreviewerSpec:
